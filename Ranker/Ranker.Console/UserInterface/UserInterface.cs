...
internal class UserInterface
{
    ...
    private string InputNotWhiteSpace(string message)
    {
    ...
    private void UpdateScore(Score score, ScoreBoard currentScoreBoard)
    {
        System.Console.Clear();
        try
        {
    ...
    private void DeleteScore(int scoreId, ScoreBoard scoreBoard)
    {
    ...
    private void DeleteScoreBoard(int id)
    {
